...
def setup():
    ...
    circulo_01 = list(circulo(100, 400, -400))
    circulo_02 = list(circulo(140, -400, 440))
    circulo_ = list(circulo(130, -200, -300))
    shuffle(circulo_01)
    shuffle(circulo_02)
    shuffle(circulo_)
    CIRCULO = circulo_
    ...
    for idx, (p1, p2) in enumerate(PONTOS):
        ...
        x2 = p2[0] + x0
        y2 = p2[1] + y0
        x = (x1 + x2) / py5.random_int(2, 4)
        y = (y1 + y2) / py5.random_int(2, 4)
        final.append((x, y))
