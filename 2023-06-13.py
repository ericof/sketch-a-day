...
def setup():
    ...
    for _ in range(0, 125):
        sep_radius = py5.random(300, 350)
        pds_list.append(
            (
                PoissonDiscSampling(0, 0, WIDTH, HEIGHT, sep_radius, 1, 0, 20),
                py5.color(py5.random(360), 100, py5.random(80, 100), py5.random(2, 5)),
            )
        )
