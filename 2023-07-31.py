...
def sorteia_cor():
    ...
    return padrao if valor < 6 else choice(PALETA)
...
def setup():
    ...
    PALETA = [
        py5.color(0, 100, 50),
        py5.color(0, 50, 50),
        py5.color(30, 100, 100),
        py5.color(30, 50, 50),
        py5.color(60, 100, 100),
        py5.color(60, 50, 50),
    ]
    passo_grid = 80
    buffer = passo_grid / 2
