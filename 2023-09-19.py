...
def pixelate_image(img_1_data, pixel_size: int) -> np.array:
    ...
    new_image = data[y_min:y_max, x_min:x_max]
    return new_image[::pixel_size, ::pixel_size]
...
def setup():
    ...
    img_data = pixelate_image(img_1_data, 20)
