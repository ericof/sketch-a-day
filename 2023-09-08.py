...
def draw():
    ...
    with py5.push_matrix():
        py5.translate(WIDTH // 2, HEIGHT // 2, -frame * 4)
        py5.rotate_y(py5.radians(frame * 5))
        py5.rotate_x(py5.radians(frame * 5))
        py5.rotate_z(py5.radians(frame * -5))
        xa = np.linspace(0, 20000, 20001)
        for x in xa:
