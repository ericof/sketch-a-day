...
def draw():
    py5.background(120, 80, 80)
    py5.stroke_weight(6)
    for x, y in GRADE:
        h = py5.random_int(220, 250)
        s = py5.random_int(0, 1)
        b = py5.random_int(99, 100)
        py5.stroke(h, s, b)
        ...
        if direcao == 0:
            ...
            coordenadas = (x + terco_largura, y, x + 2 * terco_largura, y + ALTURA)
        elif direcao == 3:
            coordenadas = (x, y + terco_altura, x + LARGURA, y + 2 * terco_altura)
        elif direcao == 4:
            coordenadas = (x + 2 * terco_largura, y, x + terco_largura, y + ALTURA)
        elif direcao == 5:
            coordenadas = (x, y + 2 * terco_altura, x + LARGURA, y + terco_altura)
