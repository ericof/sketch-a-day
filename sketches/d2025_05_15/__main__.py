...
def gera_colecao() -> list[t.Padrao]:
    payload = {"traco": 8}
    padrao_01 = b.Biblioteca.get_padrao("HexagonoConcentricos3")
    colecao = [padrao_01(**payload)]
    return colecao
