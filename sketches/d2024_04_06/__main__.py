"""2024-04-06
Mosaico IV
Exercício de criação de um mosaico em uma grade, utilizando elipses.
png
...
def setup():
    ...
    for x, y in grade:
        h = py5.random_int(280, 300)
        s = py5.random_int(0, 2)
        b = py5.random_int(40, 70)
        py5.fill(h, s, b)
        x, y = centro_celula(x, y, largura, altura)
        escala_x = py5.random(0.6, 1.2)
        escala_y = py5.random(0.4, 1.2)
        angulo = py5.random_int(-60, 60)
