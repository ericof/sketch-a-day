...
def gera_grade(
    ...
    for idx, xb, idy, yb in grade:
        ...
        with pg.begin_draw():
            for iidx, diametro in enumerate(range(diametro_max, diametro_min, -20)):
                with pg.push():
                    angulo = -15 if iidx % 2 == 0 else 15
...
def setup():
    ...
    grade = gera_grade(-meio_x, -meio_y, meio_x, meio_y, 1200, 10, 30, 25, paleta)
