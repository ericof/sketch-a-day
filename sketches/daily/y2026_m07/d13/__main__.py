...
ajuste: int = -15
tamanho_inicial: int = 1050
tamanho_final: int = 20
passo: int = -25
tamanhos = list(range(tamanho_inicial, tamanho_final, passo))
rotacao_inicial: int = 0
rotacao_passo: float = 0.15
total = len(tamanhos)
h, s, b = rgb_hex_to_hsb("#21617D")
    ...
    with py5.push():
        ...
        for idx, tamanho in enumerate(tamanhos):
            forma = gera_poligono_regular(
                lados=8, largura=tamanho, altura=tamanho, rotacao=rotacao
            )
