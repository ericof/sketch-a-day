...
def setup():
    ...
    paleta = gera_paleta("laranja-02", True)
    cor_base = py5.color("#FF7000")
    dados: mapas.GeodataEscalado = mapas.escala_dados(
        mapas.obtem_dados("Comuna 13, Medellín", pasta=sketch.path, percentual=200),
    )
