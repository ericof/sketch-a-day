...
def setup():
    global estencil, mascara
    py5.size(*helpers.DIMENSOES.external, py5.P3D)
    inicializa()
    mascara = resource_image_as_array("sampa-reverso.png")
    estencil = estencil_como_forma(
        mascara, cor_fundo, profundidade=profundidade_estencil
    )
...
def draw():
    ...
    with py5.push():
        ...
        with py5.push():
            py5.translate(*helpers.DIMENSOES.pos_interno, profundidade_caco + 1)
            py5.shape(estencil)
    py5.no_lights()
