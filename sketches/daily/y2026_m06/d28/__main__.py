...
def setup():
    ...
    estencils = []
    for z, cor in ((-20, CORES[0]), (-15, CORES[1]), (-5, CORES[2]), (0, cor_fundo)):
        estencils.append((z, estencil_como_forma(mascara, cor)))
...
def draw():
    ...
    with py5.push():
        ...
        # cacos. Atuam so aqui; o no_lights() abaixo protege o overlay.
        py5.ambient_light(
