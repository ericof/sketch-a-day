"""2025-09-04
Conexões em PI (05) -- 314 dígitos
Circulo com conexões dos primeiros 314 dígitos de PI.
...
def desenha(limite: int | None = None):
    ...
    with py5.push():
        ...
        # desenha_borda(0, 0, RAIO, TRACO_CIRCULO, TRACO_CIRCULO - 8, "#000")
