...
def campo_vetor(vetor: py5.Py5Vector2D, escala: float) -> py5.Py5Vector2D:
    ...
    novo_vetor = cast(py5.Py5Vector2D, py5.Py5Vector2D(v, u))
    return novo_vetor
...
def setup():
    ...
    for x in range(110, 901, 60):
        for y in range(110, 901, 60):
            grossura = py5.random_int(15, 35)
            escala = py5.random_int(10, 60)
