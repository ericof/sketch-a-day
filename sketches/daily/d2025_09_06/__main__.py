"""2025-09-06
Conexões em PI (07) -- 628 dígitos
Circulo com conexões dos primeiros 628 dígitos de PI.
...
def desenha_legenda(cx: float, cy: float, raio: float, traco: int):
    ...
    for idx in range(10):
        ...
        draw_text_box(str(idx), "numero", bx, by, font_size=30)
...
def desenha(limite: int | None = None):
    ...
    with py5.push():
        ...
        draw_text_box("π", "numero", *centro, font="Georgia-BoldItalic", font_size=74)
    # Credits and go
    canvas.sketch_frame(
