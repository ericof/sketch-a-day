"""2025-11-22
Polígonos -> Círculos 04
Exercício de criação de polígonos com muitos lados, aproximando círculos.
ericof.com
png
...
def setup():
    ...
    paletas = deque([
        ...
        gera_paleta("tons-azul-01", True),
        gera_paleta("pycon-colombia-2025", True),
        gera_paleta("bright-colors", True),
        gera_paleta("laranja-01", True),
    ])
    passo = 80
    traco = 6
    passo_interno = traco * 2
    forma_largura = passo * 2
    forma_altura = passo * 2
    lados = 90
    rotacao = np.pi / lados
