...
raio_dodecaedro = 300
profundidade_face = 15
# Distância das 4 luzes externas (vértices de tetraedro).
dist_luzes_externas = 600
intensidade_luz_externa = 200
...
def cria_face_pentagono(
    ...
    cor_metalica = py5.color(90, 90, 97)
    for i in range(5):
        j = (i + 1) % 5
...
def draw():
    ...
    with py5.push():
        ...
        # Luz pontual no centro do dodecaedro (fonte interna).
        py5.point_light(255, 250, 240, 0, 0, 0)
        # 4 luzes externas nos vértices de um tetraedro regular.
        r = dist_luzes_externas
        lv = intensidade_luz_externa
        py5.point_light(lv, lv, lv, r, r, r)
        py5.point_light(lv, lv, lv, r, -r, -r)
        py5.point_light(lv, lv, lv, -r, r, -r)
        py5.point_light(lv, lv, lv, -r, -r, r)
