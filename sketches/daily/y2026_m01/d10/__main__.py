...
def draw():
    ...
    areas = [
        ...
        (0, 400, gera_paleta("pycon-colombia-2025", True)),
        (0, 600, gera_paleta("Navy-Orange", True)),
        ...
        (400, 400, gera_paleta("pycon-colombia-2025", True)),
        (400, 600, gera_paleta("Navy-Orange", True)),
