...
sep = py5.random(0.45, 0.75)
num_layers = py5.random_choice(list(range(4, 12)))
            ...
            with py5.begin_shape():
                ...
                while step <= steps:
                    ...
                    if _j < previous_j:
                        ...
                        py5.vertex(largura + 200, altura + 200)
                        py5.vertex(-200, altura + 200)
