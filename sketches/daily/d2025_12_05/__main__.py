"""2025-12-05
Mapas v2: Exílio 01
Mapa do bairro de Friedrichshain, em Berlim, Alemanha.
...
def setup():
    ...
    caminhos = {
        "roads": {"tag": {"highway": True}, "paleta": deque(["#8C8C8C"])},
        "rail": {"tag": {"railway": True}, "paleta": deque(["#585858"])},
    }
    limite = "Friedrichshain, Berlin, Germany"
    endereco = "Ebertystraße 31, 10249 Berlin, Germany"
