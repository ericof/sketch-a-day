...
def draw():
    ...
    with py5.push_matrix():
        for idx, (x, y) in enumerate(PONTOS):
            ...
            forma.rotate(py5.radians(py5.random_int(90, 270)))
            width = py5.random_int(int(tamanho * 0.5), int(tamanho * 1.5))
            height = py5.random_int(int(tamanho * 0.5), int(tamanho * 1.5))
            py5.shape(
                forma,
                x,
                y,
